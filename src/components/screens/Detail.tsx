...
const PERIODS_STOCK: Period[] = ['1분', '5분', '30분', '1시간', '일봉', '주봉', '월봉']; // KIS 분봉(4시간 미지원)
// 차트 봉 표시 라벨(트레이딩뷰 스타일). 내부 값은 한글 Period 유지.
const PERIOD_LABEL: Record<Period, string> = { '1분': '1m', '5분': '5m', '15분': '15m', '30분': '30m', '1시간': '1H', '4시간': '4H', '일봉': '1D', '주봉': '1W', '월봉': '1M' };
