      ...
      {items.length > 0 && (
        <>
          ...
          <div
            ...
            // overscrollBehavior:auto → 리스트 맨 위/맨 아래 경계에선 스크롤이 페이지로 이어짐(contain은 갇힘).
            style={{ display: 'flex', flexDirection: 'column', gap: 10, maxHeight: '68vh', overflowY: 'auto', overflowX: 'hidden', overscrollBehavior: 'auto', paddingRight: 4, paddingTop: 4 }}
          >
            {items.map((s, i) => (
              <button
                key={s.code}
