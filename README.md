...
- **내 관심(개인화 피드)** — 관심 분야(국내주식 12·해외주식 12·코인 6)와 관심 종목(검색해서 추가)을 고르면 대시보드 맨 위에 **내 종목 등락 · 내 업종 흐름 · 관심사에 맞는 뉴스**를 모아 표시. 보유·관심 종목은 자동 반영. 뉴스 매칭은 기존 캐시를 종목명·별칭·업종 키워드로 거르는 방식(AI 재생성 없음)
